...
Save as `docs/TaskDelegation/review/diagram_YYYYMMDD_HHMM.html`.
...
Save the full review result (Stage 1 + Stage 2) as `docs/TaskDelegation/review/{slug}_YYYYMMDD_HHMM.md`, reusing the same `{slug}` as the reviewed work cycle.
